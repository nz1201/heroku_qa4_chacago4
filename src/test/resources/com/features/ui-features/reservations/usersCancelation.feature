...
Then the user "teacheriljanettebaskett@gmail.com" "janettebaskett" click cancel and message will displayed 
...
Then the user should go schedule page 
Then the user check if it was reserved or not
Then the user "<email>" "<password>" click cancel and message will displayed 
...
And the user should select available date
Then the user should select avaliable time
And the user should select available room teamLEad user "<email>" and "<password>"
Then the user should go schedule page 
Then the user check if it was reserved or not
Then the user "<email>" "<password>" click cancel and message will displayed 
...
Then the user should go schedule page 
Then the user check if it was reserved or not
Then the user "<email>" "<password>" not click cancel and message will not displayed 
Examples:
    |email 						  	|password 	|
